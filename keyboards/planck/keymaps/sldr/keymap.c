 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Super| RAlt | Alt  |Lower | Space| Enter|Raise | Left | Up   | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_ESC,  KC_LGUI, KC_RALT, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT
),
...
[_WM] = LAYOUT_planck_grid(
    _______, _______, KC_D,    KC_R,    KC_W,    KC_B,    KC_J,    KC_F,    KC_U,    KC_P,    KC_SCLN, _______,
    _______, _______, _______, KC_H,    KC_T,    _______, KC_Y,    KC_N,    KC_E,    KC_O,    KC_I,    _______,
    _______, _______, _______, KC_M,    KC_C,    KC_V,    KC_K,    KC_L,    _______, _______, _______, _______,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Dl   |      |      |      | NOPE |             | NOPE | Home | PgUp | PgDn | End  |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  KC_BSLS,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_LPRN, KC_RPRN, _______, _______, _______,
    KC_DEL,  _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END
),

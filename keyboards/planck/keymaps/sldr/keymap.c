 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Ctrl | Meta | Alt  | Lower| Space| Enter| Raise| Left | Up   | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_WM] = LAYOUT_planck_grid(
    ...
    KC_ESC,  MU_MOD,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_LBRC, KC_RBRC, KC_EQL,  KC_PLUS, KC_DEL,

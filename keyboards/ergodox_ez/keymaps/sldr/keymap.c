...
[UTIL] = LAYOUT_ergodox_pretty(
  ...
  KC_CAPS, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,     _______, _______, _______, _______, _______, _______, _______,
  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,                       _______, SWE_LBR, SWE_RBR, SWE_MIN, SWE_UND, _______,
  _______, CLEFT,   CDOWN,   CUP,     CRGHT,   _______, _______,     _______, _______, SWE_LCB, SWE_RCB, SWE_EQL, SWE_PLS, _______,

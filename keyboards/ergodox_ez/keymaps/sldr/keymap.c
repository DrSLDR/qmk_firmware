...
[UTIL] = LAYOUT_ergodox_pretty(
  ...
  _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   _______,     _______, _______, _______, _______, _______, _______, KC_F12,
  _______, _______, _______, KC_P4,   KC_P5,   KC_P6,                         _______, KC_LBRC, KC_RBRC, KC_MINS, KC_EQL,  _______,
  _______, _______, _______, KC_P1,   KC_P2,   KC_P3,   _______,     _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______,

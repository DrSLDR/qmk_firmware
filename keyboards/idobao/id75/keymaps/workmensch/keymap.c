 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | ESC    | LGUI   | FN     | LALT   | SPACE  | SPACE  | NUMLCK | P0     | CMB TOG| SPACE  | SPACE  | LEFT   | UP     | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  [_WM] = LAYOUT_ortho_5x15( /* Workmensch */
    ...
    KC_ESC,           KC_LGUI, MO(_FN), KC_LALT, KC_SPC,  KC_SPC,  KC_NLCK, KC_P0,   CMB_TOG, KC_SPC,  KC_SPC,  KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT  \
 ),
 ...
 */
  ...
  */
   ...
   * |        | F1     | F2     | F3     | F4     | F5     | F11    | RESET  | F12    | F6     | F7     | F8     | F9     | F10    | DEL    |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * |        |        |        |        |        |        | P7     | P8     | P9     | -      | SE {   | SE }   | SE =   | SE +   |        |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * |        | PREV   | PLAY   | NEXT   | STOP   |        | P4     | P5     | P6     | +      | SE [   | SE ]   | SE '   | SE "   |        |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   * |        | VOL-   | MUTE   | VOL+   |        |        | P1     | P2     | P3     | PENT   |        |        | SE -   | SE _   |        |
   * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
   ...
   */
   ...
   [_SE_FN] = LAYOUT_ortho_5x15( /* SWEDISH FUNCTION */
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F11,  RESET,   KC_F12,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  \
      _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_MINS, SWE_LCB, SWE_RCB, SWE_EQL, SWE_PLS, _______, \
      _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, _______, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, SWE_LBC, SWE_RBC, SWE_QOT, SWE_DQT, _______, \
      _______, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, SWE_MIN, SWE_USC, _______, \

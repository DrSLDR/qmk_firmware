...
const uint16_t PROGMEM ej_combo[]  = {KC_E, KC_J, COMBO_END};       // É, é
...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [EJ_EACUT] = COMBO_ACTION(ej_combo),      // É, é
  [SS_CAPS] = COMBO_ACTION(ss_combo)        // Caps
};

// Helper macros
#define ALSFT A(KC_LSFT)
#define ALCTL A(KC_LCTL)
 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | LCTRL  | A      | S      | D      | F      | G      | ALCTL  | MUTE   | VOL+   | H      | J      | K      | L      | ;      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | ALSFT  | NOOP   | LCA    | N      | M      | ,      | .      | /      | RSHFT  |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | ESC/FN | LGUI   | OSL    | LALT   | FN     | SPACE  | LALT   | CAPS   | RALT   | ENTER  | FN     | LEFT   | UP     | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    ALCTL,   KC_MUTE, KC_VOLU, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    ALSFT,   XXXXXXX, KCLCA,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    ESCFN,   KC_LGUI, KCOSL,   KC_LALT, MO(_FN), KC_SPC,  KC_LALT, KC_CAPS, KC_RALT, KC_ENT,  MO(_FN), KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT  \
 ),
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    _______, _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______, \
